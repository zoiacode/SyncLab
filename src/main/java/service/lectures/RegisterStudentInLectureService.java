...
public class RegisterStudentInLectureService {
    ...
    public RegisterStudentInLectureService(Connection connection) {
    ...
    public void execute(
        ...
        try {
            ...
            this.lectureDao.registerStudentInClass(student.getId(), lectureId);        
        

            CreateNotificationService notification = new CreateNotificationService(this.connection);
            String NotificationText = "Estudante: " + person.getName() + " se registrou na aula: " + lecture.getSubjectName(); 
            notification.execute(professor.getPersonId(), "Novo aluno registrado", NotificationText);
